...
Need more stuff on introduction. Talk about little context that single articles have. What other summarizers do (machine learning?) Pros and cons of the machine learning techniques (complex, needs training data).
